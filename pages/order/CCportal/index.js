    ...
    return (
        <div>
            ...
            <iframe width={"100%"} style={{height: "90vh"}} frameBorder="0" id="paymentFrame"
                    src={"https://test.ccavenue.com/transaction/transaction.do?command=initiateTransaction&merchant_id=130447&encRequest=" + router.query.token + "&access_code=AVNT04JE31CN09TNNC"}>
            </iframe>
        </div>
    );
};
