    ...
    const browserView = (
        <div className={`flex flex-col gap-y-8 text-justify w-1/2 mx-auto text-[#777]`}>
            ...
            <div className={blockStyle}>
                ...
                <p>
                    <span className={blockLeadStyle}>2.3</span> All trademarks, trade names, logos and other distinctive designs and signs which are reproduced
                ...
                <p>
                    <span className={blockLeadStyle}>2.4</span> This Website is solely for private, personal and non-commercial use, and the Material on this
                    Website is presented for information and/ or promotional purposes only.
                </p>
                <p>
                    <span className={blockLeadStyle}>2.5</span> It is not permitted to reproduce (except where the reproduction is made for personal
                ...
                <p>
                    <span className={blockLeadStyle}>2.6</span> Saltattire is fully committed to maintain, enforce and protect its intellectual property rights
            ...
            <div className={blockStyle}>
                ...
                <p><span className={blockLeadStyle}>3.2</span> Saltattire is not required or will not be required in the future to:</p>
                <p><span className={blockLeadStyle}>(i)</span> Keep any Submitted Material confidential;</p>
                <p><span className={blockLeadStyle}>(ii)</span> pay compensation for any use of the Submitted Material or in connection to it;</p>
                <p><span className={blockLeadStyle}>(iii)</span> respond to the submission of Submitted Material and / or confirm the relevant receipt.</p>
                <p>
                    <span className={blockLeadStyle}>3.3</span> You declare and warrant that the Submitted Material does not violate any rights of third parties
                ...
                <p>
                    <span className={blockLeadStyle}>3.4</span> By submitting the Submitted Materials, you acknowledge the right, but not the obligation, of
                ...
                <p>
                    <span className={blockLeadStyle}>3.5</span> Saltattire retains the right to reject or delete any Submitted Material for any or no reasons,
            ...
            <div className={blockStyle}>
                ...
                <p>
                    <span className={blockLeadStyle}>4.1</span> This Website may contain links to other websites. Saltattire has no control over such websites
                    and will not be responsible or liable for any accessibility of third party websites or for their
                    content.
                </p>
                <p>
                    <span className={blockLeadStyle}>4.2</span> Hyperlinks to other websites and references to information, products or services of third parties
                ...
                <p>
                    <span className={blockLeadStyle}>4.3</span> You are not permitted to frame this Website on any other website or to link to any part or
            ...
            <div className={blockStyle}>
                ...
                <p>
                    <span className={blockLeadStyle}>6.2</span> SALTATTIRE WORKS TO ENSURE THAT THE INFORMATION MADE AVAILABLE THROUGH THE WEBSITE IS ACCURATE
            ...
            <div className={blockStyle}>
                ...
                <p>
                    <span className={blockLeadStyle}>7.1</span> AS THE SERVICE IS PROVIDED FREE OF CHARGE, YOU ARE RESPONSIBLE FOR EVALUATING THE INFORMATION AND
                ...
                <p>
                    <span className={blockLeadStyle}>7.2</span> TO THE EXTENT PERMITTED BY APPLICABLE LAW, YOU ALSO UNDERTAKE NOT TO HOLD US, OUR LICENSORS,
                ...
                <p><span className={blockLeadStyle}>7.4</span> IT IS UNDERSTOOD THAT NOTHING IN THESE TERMS OF USE SHALL EXCLUDE OR LIMIT:</p>
                <p>
                    <span className={blockLeadStyle}>(I)</span> OUR LIABILITY IN CASE OF DEATH OR PERSONAL INJURY;
                    <span className={blockLeadStyle}>(II)</span> OUR LIABILITY IN CASE OF FRAUD, FRAUDULENT MISREPRESENTATION OR GROSS NEGLIGENCE;
                    <span className={blockLeadStyle}>(III)</span>AND/OR ANY OTHER LIABILITY THAT CANNOT BE EXCLUDED OR LIMITED BY APPLICABLE LAW.
                </p>
            </div>
            <div className={blockStyle}>
            ...
            <div className={blockStyle}>
                ...
                <p>
                    <span className={blockLeadStyle}>9.1</span> These Terms of Use and any non-contractual obligations arising out of or in relation to the Terms
