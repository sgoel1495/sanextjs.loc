...
function ContactUsPage() {
    ...
    const mobileView = <section className="container my-20 grid grid-cols-1 gap-x-10 items-start justify-center">
        ...
        <div>
            <p>SALT CARE Team is happy to help! We will get back to you within 24 hours.</p>
            <div className={"grid grid-cols-2"}>
                <div>
                    <span className={"block"}>Call Us</span>
                    <span className={"block"}>18002709515</span>
                </div>
                <div>
                    <span className={"block"}>Email us</span>
                    <span className={"block"}>care@saltattire.com</span>
                </div>
            </div>
            <div className={"text-center"}>
                <span className={"block"}>Mon to Fri - 9:00 am to 7:00 pm</span>
                <span className={"block"}>Sat - 9:00 am to 2:00 pm</span>
            </div>
            <button className={`bg-black font-500 px-12 py-3 text-white uppercase`}>Contact Us</button>
        </div>
        <div className={"flex"}>
            <div>
                <svg xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 576 512" height={"30"} fill={"#777"}>
                    <path
    ...
    return (
        <Fragment>
            ...
            </div>
            {
                dataStore.mobile ?
                    <>
                    <span className={"block relative w-[100vw] aspect-[16/9] mt-[-4vw]"}>
                        <Image src={WEBASSETS + "/assets/images/ContactUs.mob.2_v1.jpg"} layout={`fill`} objectFit={`contain`} className={"bottom-0"}/>
                    </span>
                        {mobileView}
                    </>
                    :
