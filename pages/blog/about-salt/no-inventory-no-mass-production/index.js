...
const Index = ({isMobile}) => {
    ...
    const shareOnTwitter = () => {
        let url = 'https://twitter.com/intent/tweet?url=' + `https://saltattire.com/blog/about-salt/no-inventory-no-mass-production`;
        window.open(url, 'TwitterWindow', "width = 1200, height = 600");
        return false;
    }
    const shareOnFB = () => {
        let url = 'https://www.facebook.com/dialog/share?app_id=253839508451663&display=popup&href=' + `https://saltattire.com/blog/about-salt/no-inventory-no-mass-production`;
        window.open(url, 'FacebookWindow', "width = 1200, height = 600");
        return false;
    }

    const copyToClipboard = () => {
        navigator.clipboard.writeText("https://saltattire.com/blog/about-salt/no-inventory-no-mass-production");
        setShow(true)
    }
    ...
    return (
        <>
            <PageHead url="/bolg/about-salt/no-inventory-no-mass-production" id="no-inventory-no-mass-production" isMobile={isMobile}/>
