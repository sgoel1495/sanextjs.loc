...
function BlogWhyCustomTailoredClothingPage({appConfig}) {
    ...
    return (
        <Fragment>
            <PageHead url="/blog/about-salt/why-custom-tailored-clothing" id="why-custom-tailored-clothing" isMobile={appConfig.isMobile}/>
...
export default connect(mapStateToProps)(BlogWhyCustomTailoredClothingPage);
