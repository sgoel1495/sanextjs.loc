...
function BlogStylingServicePage({appConfig}){
        ...
        <section className={`container`}>
          <Link  href="/blog/about-salt" passHref>
            ...
            <div className="col-span-3">
                <StylingServices isMobile={true} main={true}/>
    ...
    return (
        <Fragment>
            <PageHead url="/blog/about-salt/styling-service" id="styling-service" isMobile={appConfig.isMobile}/>
...
export default connect(mapStateToProps)(BlogStylingServicePage);
