    ...
    const mobileView = props.minimal ?
        ...
        <footer className={`bg-[${props.color}] p-4`}>
            <div className="text-sm flex flex-col gap-5 items-center mb-10 text-black/50 font-500">
                <p className="text-sm font-bold">SALT CARE Team is happy to help! We will get back to you within 24 hours.</p>
                ...
                <button className={`bg-black font-500 px-12 py-3 text-white uppercase tracking-widest`}>Contact Us</button>
            </div>
            <div className={"flex"}>
                <div>
            ...
            <footer className="bg-[#222222] py-2">
                ...
                <div className="px-[10%] pb-[15%] text-white text-sm">
                    ...
                    <div className="my-5 flex h-[50px] rounded-[2%] overflow-hidden">
                        <input className={"w-[82%] p-[1%] text-[15px] text-black"} type={"email"} placeholder={"Email Address"} ref={newsletterRef} />
                ...
                <div className="justify-center flex">
                    ...
                    <div onClick="change_currency()" className="px-3 py-1">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 576 512" height={"35"} fill={"white"}>
