...
function UserLogin(props) {
    ...
    */
    ...
    switch (active) {
        case 0:
            ActiveForm = <LoginForm showToast={showToast} setShowLogin={props.setShowLogin} isMobile={props.isMobile} />
            break;
        case 1:
                ...
                >
                    ...
                    <div className={`flex items-center gap-x-4 text-sm uppercase text-black/60`}>
                        {(active == 0)
                            ? <Fragment>
                                <div
                                    className={active === 0 ? `underline text-black/80 cursor-default  font-bold` : 'cursor-pointer'}
                                    onClick={() => setActive(0)}>Sign In
                                </div>
                                <span>|</span>
                                <div
                                    className={active === 1 ? `underline text-black/80 cursor-default` : 'cursor-pointer'}
                                    onClick={() => setActive(1)}>Sign Up
                                </div>
                                <span>|</span>
                                <div
                                    className={active === 2 ? `underline text-black/80 cursor-default` : 'cursor-pointer'}
                                    onClick={() => setActive(2)}>Forgot your password?
                                </div>
                            </Fragment>
                            : (active == 1)
                                ? <Fragment>
                                    <div
                                        className={active === 1 ? `underline text-black/80 cursor-default  font-bold` : 'cursor-pointer'}
                                        onClick={() => setActive(1)}>Sign Up
                                    </div>
                                    <span>|</span>
                                    <div
                                        className={active === 0 ? `underline text-black/80 cursor-default` : 'cursor-pointer'}
                                        onClick={() => setActive(0)}>Sign In
                                    </div>
                                    <span>|</span>
                                    <div
                                ...
                                : (active == 2)
                                    ? <Fragment>
                                        <div
                                            className={active === 2 ? `underline text-black/80 cursor-default  font-bold` : 'cursor-pointer'}
                                            onClick={() => setActive(2)}>Forgot your password?
                                        </div>
                                        <span>|</span>
                                        <div
        ...
        <>
            <div id="userlogindiv" className={props.inBody?"mt-20":`bg-theme-900/50 fixed inset-0 z-40`}>
                <div
                    ...
                    onClick={(e) => e.stopPropagation()}
                >
                    <button className={`w-8 h-8 absolute right-3 top-3`} onClick={closeModal}>
                        <svg xmlns="http://www.w3.org/2000/svg" className={`w-8 h-8`} viewBox="0 0 24 24">
                            <path
                                d="m16.192 6.344-4.243 4.242-4.242-4.242-1.414 1.414L10.535 12l-4.242 4.242 1.414 1.414 4.242-4.242 4.243 4.242 1.414-1.414L13.364 12l4.242-4.242z"/>
                        </svg>
