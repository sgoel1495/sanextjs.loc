...
function StylingServices(props) {
    ...
    const mobileView =  (
        <section className={`flex flex-col gap-y-5 font-cursive text-2xl my-10 px-4`}>
            <p className={`text-2xl font-400 text-center`}>Styling Services</p>
            {(props.main)
            ...
            <p>
                ...
                <p>We provide Styling Services too!
                ...
                <Link href="/get-appointment" passHref>
                    <b><u>Book Your Free Styling Appointment </u></b>
                </Link>
                <p>in Store Now, or Contact Us, email care@saltattire.com, call or whatsapp +91 9015904904 for a Virtual Styling Session!
            </p>
        </section>
    );
    const browserView = (
