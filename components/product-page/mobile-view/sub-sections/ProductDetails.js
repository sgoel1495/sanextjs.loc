            ...
            <div className="px-5 pt-5">
                ...
                <div className={"flex flex-col items-center"}>
                    ...
                    <div className={"inline-flex items-center gap-6 mb-5"}>
                        <div className={"border-4 border-white bg-[#faede3] shadow-xl text-center px-4 py-2.5 leading-none rounded-[5vw]"}>
                    ...
                    <div className='flex justify-start flex-wrap w-full'>
                        {["shirts", "Long Sleeves"].map((item, index) => {
                            return <p className={"rounded-full capitalize font-cursive italic font-600 bg-[#faede3] border-2 border-white px-3 pt-1 text-sm mb-4 mr-4"} key={index}>{item}</p>
                        })}
                    </div>
                </div>
            </div>
