...
const AffordableLuxury = props => {
    ...
    const mobileView = (
        ...
        >
            ...
            <div className={`bg-black/30 text-white pt-7 pb-3 pr-3 mr-8`}>
                <p className={`px-10 text-xl mb-5 font-cursive italic`}>Affordable Luxury</p>
                <div className="bg-black px-5 py-3 text-[12px] leading-5 tracking-wide">
